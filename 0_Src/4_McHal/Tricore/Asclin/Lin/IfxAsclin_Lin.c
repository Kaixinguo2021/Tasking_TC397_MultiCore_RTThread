...
void IfxAsclin_Lin_initModuleConfig(IfxAsclin_Lin_Config *config, Ifx_ASCLIN *asclin)
{
    ...
    config->interrupt.rxPriority    = 100;                                                       /* receive interrupt priority 0*/
    config->interrupt.txPriority    = 101;                                                       /* transmit interrupt priority 0*/
    ...
    config->isInterruptMode         = TRUE;                                                   /* default is in polling mode*/
