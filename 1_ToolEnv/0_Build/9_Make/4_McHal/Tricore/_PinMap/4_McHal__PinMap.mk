...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxCif_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxCif_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxCif_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxCif_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxCif_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '

OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxDsadc_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxI2c_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxI2c_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxI2c_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxI2c_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxI2c_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '

OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxMsc_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxMsc_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxMsc_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxMsc_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxMsc_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '

OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5_PinMap.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5_PinMap.d

2_Out/Gnuc/0_Src/4_McHal/Tricore/_PinMap/IfxPsi5_PinMap.o: 0_Src/4_McHal/Tricore/_PinMap/IfxPsi5_PinMap.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/4_McHal/Tricore/_PinMap/IfxPsi5_PinMap.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
